        ...
        <table class="table table-bordered table-striped" id="example1">
            ...
            @foreach($data as $value)
                <tr>
                    ...
                    <td>{{$value->name}}</td>
                    <td>{{$value->seo}}</td>
                    <td><a href="/admin/edite-brand/{{$value->id}}" class="btn fa fa-edit"></a></td>
                    <td><a href="/admin/delete-brand/{{$value->id}}" class="btn fa fa-trash" onclick="return confirm('آیا مطمئن هستید؟')"></a></td>
                </tr>
            @endforeach
            </tbody>
        </table>
